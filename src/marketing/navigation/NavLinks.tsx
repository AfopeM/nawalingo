...
export default function NavLinks({ isMobile = false }: NavLinksProps) {
  const getButtonClasses = () => {
    ...
    const mobileStyles =
      "w-full justify-center py-8 text-xl text-nawalingo-gray-light/75 hover:bg-nawalingo-light/10 hover:text-nawalingo-light dark:text-nawalingo-gray-dark/75 hover:dark:bg-nawalingo-dark/10 hover:dark:text-nawalingo-dark";
  ...
  const getContainerClasses = () => {
    ...
    const mobileContainer = "flex gap-y-10 flex-col justify-start";
